...
export interface DialogProps {
  ...
  groups: Group[];
  dialogClose: () => void;
  handleSelectorEdit: (newSelector: ClashProxyGroupSelector) => void;
}

class SelectorEditDialog extends React.Component<DialogProps, object> {
  constructor(props: DialogProps) {
    super(props);
  }

  render() {
    const { open, groups, selector, selectors, dialogClose, handleSelectorEdit } = this.props;
    ...
    let initialValues: ClashProxyGroupSelector = { ...selector, proxySelectors: proxySelectors };
    return (
      <Dialog open={open} onClose={dialogClose} aria-labelledby="form-dialog-title">
        <Formik
          ...
          onSubmit={async values => {
            ...
            await handleSelectorEdit(result);
          }}
        >
          {props => {
            const {
...
export default SelectorEditDialog;
