...
import (
	...
	"github.com/goomadao/subscribeManager/apis"
...
func initConfig() {
	if config.CfgFile != "" {
		...
		// Search config in home directory with name ".subscribeManager" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".subscribeManager")
	}
